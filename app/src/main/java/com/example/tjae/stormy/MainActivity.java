...
import com.example.tjae.stormy.weather.Current;
import com.example.tjae.stormy.weather.Day;
import com.example.tjae.stormy.weather.Forecast;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final double latitude = 17.983333;
        final double longitude = -76.80000000000001;
    ...
    private void getForecast(double latitude, double longitude) {
        String apiKey = "af1530eee59ce29b15ef8e96c88383e1";
    ...
    private void updateDisplay() {
        ...
        mHumidityValue.setText(current.getHumid()+ "");
